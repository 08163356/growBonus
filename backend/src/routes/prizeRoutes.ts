...
router.post('/', protect, authorize('admin'), rejectGuest, upload.array('images', 2), prizeController.create);
router.put('/:id', protect, authorize('admin'), rejectGuest, upload.array('images', 2), prizeController.update);
...
router.put('/redemptions/:id/approve', protect, authorize('admin', 'parent'), rejectGuest, upload.array('images', 3), prizeController.approve);
router.put('/redemptions/:id/reject', protect, authorize('admin', 'parent'), rejectGuest, upload.array('images', 3), prizeController.reject);
